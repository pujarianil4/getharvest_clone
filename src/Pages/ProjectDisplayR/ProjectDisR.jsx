    ...
    <div className={styles.body}>
      ...
      <div className={styles.topBarR}>
        ...
        <div className={styles.SearchClient}>
          <input type="text" placeholder="Search By Client or Project Name" />
        </div>
      </div>
      {/* Top Bar ending */}
      ...
      <div className={styles.pcodeClass}>
        ...
        <h2 style={{ marginTop: "-5px", marginLeft: "1%", marginRight: "1%" }}>
          PROJECT NAME
        </h2>
      ...
      <div style={{ marginLeft: "15%" }}>startDate-EndDate(days left)</div>
      <div style={{ marginLeft: "15%" }}>Notes</div>
      <div className={styles.GraphBox}>
        <div className={styles.ProgressBox}>
          <button>Project Progress</button>
      ...
      <div style={{ marginLeft: "30%", marginTop: "2%" }}>
        <button onClick={() => setShowt(true)} className={styles.TaskBtn}>
          TASK
        </button>
        <button>TEAM</button>
        <button onClick={() => setShowt(false)} className={styles.TaskBtn}>
          Invoices
        </button>
      </div>
      ...
      <div className={styles.downbar}>
        <div className={styles.trailBox}>
          29 days left in your free trial <button>Upgrade</button>
        </div>
        <div>
          <h1 style={{ color: "grey" }}>HARVEST</h1>
        </div>
      </div>
    </div>
  );
