        ...
        <form autocomplete="off">
          <div className={styles.InputBoxes}>
            ...
            <div className={styles.inputs}>
              ...
              <div>
                <textarea
                  placeholder="Optional, but great for notes like invoice schedules. You can see notes when creating an invoice for Fixed Fee projects."
                  rows="3"
                  onChange={handleInp}
                  name="notes"
                  value={inp.notes}
          ...
          <div className={styles.projectypesBox}>
            ...
            <div className={styles.projectRight}>
              <div className={styles.projectButtons}>
                <button onClick={handleTimeAndMaterials}>
                  {" "}
                  <div></div>Time & Materials
                </button>
                <button onClick={handleFixedFee}>
                  {" "}
                  <div></div>Fixed Fee
                </button>
                <button onClick={handleNonBillable}>
                  {" "}
                  <div></div>Non Billable
                </button>
              </div>
              ...
              <div className={styles.ProjectTypeCategory}>
                {timeMaterial ? (
                    ...
                    <div>
                      ...
                      <div>
                        ...
                        <input
                          onChange={handleInp}
                          name="fixedfeebudget"
                          value={inp.fixedfeebudget}
                          placeholder="Fixed FeeBudget"
                        />
                      </div>
                    </div>
                  </div>
                  ...
                  <div className={styles.ProjectTypeCategoryChild}>
                    <div>
                      <div>
                        <label>Non-Billable Budget</label>
                      </div>
                      <div>
                        {" "}
                        <input
                          onChange={handleInp}
                          name="nonbillablebudget"
                          value={inp.nonbillablebudget}
                          placeholder="Non-Billable Budget"
                        />{" "}
                      </div>
                    </div>
                  </div>
