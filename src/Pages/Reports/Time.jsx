...
export default function Time() {
  const uninvoiced_amount = 0.0;
  //const billableHours = 8;
  const isLoadingProject = useSelector(
    (state) => state.reports.isLoadingProject
  );
  ...
  const projectReportData = useSelector(
    (state) => state.reports.projectReportData
  );
  ...
  //eslint-disable-next-line
  let totalHours =
    (!isLoadingProject && !isLoadingTask && arry.reduce((e, a) => e + a)) || 0;
