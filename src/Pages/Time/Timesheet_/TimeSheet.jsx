...
export const Timesheet = () => {
  ...
  const project_fun = () => {
    ...
    let project = clientObj.filter(
      (item) => item.pname === formData.projectName
    );
  ...
  return (
    <div>
      ...
      <TimeSheetWrapper>
        <TimeSheetContainer>
          <LeftBox>
            <AddButton onClick={() => setopenCreateTAsk(true)}>
              {" "}
              <div>+</div>
            </AddButton>
          </LeftBox>
          ...
          <div className={styles.timer_form}>
            ...
            <form>
              ...
              <div className={styles.projectName}>
                ...
                >
                  <optgroup
                    label={clientObj ? clientObj.client : "Task Name-2"}
                  >
              ...
              <div className={styles.Buttons}>
                <button className={styles.submit_btn} onClick={handleSubmit}>
                  {timer === "00:00" ? "Start Timer" : "Save Entry"}
                </button>
                <button
