  ...
  return (
    <Section>
      ...
      <Menu className={style.menu}>
        <NavLink activeStyle={{ color: "black" }} to="/time">
          Time
        </NavLink>
        <NavLink activeStyle={{ color: "black" }} to="/expense">
          Expenses
        </NavLink>
        <NavLink activeStyle={{ color: "black" }} to="/projects">
          Projects
        </NavLink>
        <NavLink activeStyle={{ color: "black" }} to="/reports">
          Reports
        </NavLink>
        <NavLink activeStyle={{ color: "black" }} to="/invoice">
          Invoices
        </NavLink>
      </Menu>
